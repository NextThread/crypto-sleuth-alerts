...
import { ExternalLink, Newspaper, TrendingUp, AlertCircle, ChevronDown, ChevronUp } from 'lucide-react';
        ...
        const mockNews: NewsItem[] = [
          {
            ...
            url: 'https://www.coindesk.com/markets/2023/10/bitcoin-surges-60000',
          ...
          },
          {
            ...
            url: 'https://www.cointelegraph.com/news/ethereum-upgrade-gas-fees',
          ...
          },
          {
            ...
            url: 'https://www.bloomberg.com/crypto/eu-regulation-framework',
          ...
          },
          {
            ...
            url: 'https://www.theblock.co/post/solana-weekly-gain',
            ...
            <div className="flex items-center gap-2">
              ...
              <CollapsibleTrigger asChild>
                <Button variant="ghost" size="sm" className="p-0 h-8 w-8 rounded-full">
                  ...
                  <span className="sr-only">Toggle news</span>
                </Button>
              </CollapsibleTrigger>
            </div>
          </div>
